...
/* ==============================================================
   ...
   ============================================================== */
const ADVISOR_PROMPT = `COMMAND: You are an Investment AI. Follow these steps exactly:
1. START directly with "Part 1 - Current Allocation Summary:".
2. DO NOT include any intro like "Certainly" or "Here is the analysis".
3. DO NOT talk about these rules.
4. Use ONLY plain text. NO stars (*), NO hashes (#), NO bolding.
5. Use a numbered list (1., 2.) for lists. No dashes (-).
6. Put a BLANK LINE between Part 1, Part 2, Part 3, and Part 4.
7. End with ONLY this line:
